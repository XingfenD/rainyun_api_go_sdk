...
//
// regionID: 地域ID
func (s *RcaService) ActivateRca(regionID int) (*common.BasicOperationResponse, error) {
	path := "/product/rca/activate"

	var resp common.BasicOperationResponse
	err := s.client.Do(constant.HTTPMethod_POST, path, nil, ActivateRcaRequest{RegionID: regionID}, &resp)
	return &resp, err
}
